...
const TopicDetail = () => {
    ...
    useEffect(() => {
        const loadTopicData = async () => {
            ...
            try {
                ...
                if (selectedModule) {
                    ...
                    setTopicData(selectedTopic || null);
                }
            } catch (error) {
        ...
        loadTopicData(); // Ensure this is called
    }, [moduleId, topicId]);
        ...
        <AnimatePresence>
            ...
            >
                ...
                {loading ? (
                    ...
                    <>
                        {/* Topic Title */}
                        <h2 className="text-2xl font-semibold text-blue-600 mb-4">{topicData?.title || "Topic not found"}</h2>
